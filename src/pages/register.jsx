            ...
            <div className=" h-[50vh] flex flex-col justify-center items-center   rounded-lg  bg-white w-[90%] md:w-[40%] m-auto">
                <div className="w-full">
                    <div className="text-xl cursor-pointer  flex flex-col justify-center items-center py-5 ">
                        <h1 className="font-semibold text-3xl text-gray-700 ">Register</h1>
                    </div>
                    ...
                    <div className="text-center px-3 ">
                        <button
                            className="uppercase px-4 py-2 rounded-md text-white bg-violet-500 hover:bg-violet-600  font-medium ">Register</button>
                    </div>
